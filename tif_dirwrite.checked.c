...
static int TIFFWriteDirectorySec(TIFF *tif, int isimage, int imagedone, _Ptr<uint64> pdiroff);

static int TIFFWriteDirectoryTagSampleformatArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
#if 0
static int TIFFWriteDirectoryTagSampleformatPerSample(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, double value);
#endif

static int TIFFWriteDirectoryTagAscii(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, char *value);
static int TIFFWriteDirectoryTagUndefinedArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint8 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagByte(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, uint8 value);
#endif
static int TIFFWriteDirectoryTagByteArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint8 *value);
#if 0
...
#endif
static int TIFFWriteDirectoryTagSbyteArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int8 *value);
#if 0
static int TIFFWriteDirectoryTagSbytePerSample(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int8 value);
#endif
static int TIFFWriteDirectoryTagShort(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint16 value);
static int TIFFWriteDirectoryTagShortArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint16 *value);
static int TIFFWriteDirectoryTagShortPerSample(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint16 value);
#ifdef notdef
static int TIFFWriteDirectoryTagSshort(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int16 value);
#endif
static int TIFFWriteDirectoryTagSshortArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int16 *value);
#if 0
static int TIFFWriteDirectoryTagSshortPerSample(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int16 value);
#endif
static int TIFFWriteDirectoryTagLong(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 value);
static int TIFFWriteDirectoryTagLongArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint32 *value);
#if 0
...
#endif
static int TIFFWriteDirectoryTagSlongArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int32 *value);
#if 0
...
#endif
static int TIFFWriteDirectoryTagLong8Array(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagSlong8(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int64 value);
#endif
static int TIFFWriteDirectoryTagSlong8Array(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int64 *value);
static int TIFFWriteDirectoryTagRational(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, double value);
static int TIFFWriteDirectoryTagRationalArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, float *value);
static int TIFFWriteDirectoryTagSrationalArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, float *value);
#ifdef notdef
static int TIFFWriteDirectoryTagFloat(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, float value);
#endif
static int TIFFWriteDirectoryTagFloatArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, float *value);
#if 0
...
#endif
static int TIFFWriteDirectoryTagDoubleArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
#if 0
static int TIFFWriteDirectoryTagDoublePerSample(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, double value);
#endif
static int TIFFWriteDirectoryTagIfdArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint32 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagIfd8Array(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, uint32 count, uint64* value);
#endif
static int TIFFWriteDirectoryTagShortLong(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 value);
static int TIFFWriteDirectoryTagLongLong8Array(TIFF *tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value);
static int TIFFWriteDirectoryTagIfdIfd8Array(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value);
#ifdef notdef
...
#endif
static int TIFFWriteDirectoryTagColormap(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir);
static int TIFFWriteDirectoryTagTransferfunction(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir);
static int TIFFWriteDirectoryTagSubifd(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir);

static int TIFFWriteDirectoryTagCheckedAscii(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, char *value);
static int TIFFWriteDirectoryTagCheckedUndefinedArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint8 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedByte(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, uint8 value);
#endif
static int TIFFWriteDirectoryTagCheckedByteArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint8 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedSbyte(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int8 value);
#endif
static int TIFFWriteDirectoryTagCheckedSbyteArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int8 *value);
static int TIFFWriteDirectoryTagCheckedShort(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint16 value);
static int TIFFWriteDirectoryTagCheckedShortArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint16 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedSshort(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int16 value);
#endif
static int TIFFWriteDirectoryTagCheckedSshortArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int16 *value);
static int TIFFWriteDirectoryTagCheckedLong(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 value);
static int TIFFWriteDirectoryTagCheckedLongArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint32 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedSlong(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int32 value);
#endif
static int TIFFWriteDirectoryTagCheckedSlongArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int32 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedLong8(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, uint64 value);
#endif
static int TIFFWriteDirectoryTagCheckedLong8Array(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedSlong8(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, int64 value);
#endif
static int TIFFWriteDirectoryTagCheckedSlong8Array(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int64 *value);
static int TIFFWriteDirectoryTagCheckedRational(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, double value);
static int TIFFWriteDirectoryTagCheckedRationalArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, float *value);
static int TIFFWriteDirectoryTagCheckedSrationalArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, float *value);

/*--: Rational2Double: New functions to support true double-precision for custom rational tag types. */
static int TIFFWriteDirectoryTagRationalDoubleArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
static int TIFFWriteDirectoryTagSrationalDoubleArray(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
static int TIFFWriteDirectoryTagCheckedRationalDoubleArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
static int TIFFWriteDirectoryTagCheckedSrationalDoubleArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
static void DoubleToRational(double value, uint32 *num : itype(_Ptr<uint32>), uint32 *denom : itype(_Ptr<uint32>));
static void DoubleToSrational(double value, int32 *num : itype(_Ptr<int32>), int32 *denom : itype(_Ptr<int32>));
#if 0
...
#endif
static int TIFFWriteDirectoryTagCheckedFloatArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, float *value);
#ifdef notdef
static int TIFFWriteDirectoryTagCheckedDouble(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, double value);
#endif
static int TIFFWriteDirectoryTagCheckedDoubleArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, double *value);
static int TIFFWriteDirectoryTagCheckedIfdArray(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint32 *value);
static int TIFFWriteDirectoryTagCheckedIfd8Array(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value);

static int TIFFWriteDirectoryTagData(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint16 datatype, uint32 count, uint32 datalength, void *data);

static int TIFFLinkDirectory(TIFF *tif : itype(_Ptr<TIFF>));
 ...
 */
int TIFFDeferStrileArrayWriting(_Ptr<TIFF> tif)
{
    ...
    if( tif->tif_diroff != 0 )
    {
        TIFFErrorExt(tif->tif_clientdata, module,
                     ((const char *)"Directory has already been written"));
        return 0;
    }
...
int TIFFWriteCustomDirectory(TIFF *tif, _Ptr<uint64> pdiroff)
{
...
int TIFFRewriteDirectory(TIFF *tif)
{
	...
	if (!(tif->tif_flags&TIFF_BIGTIFF))
	{
		if (tif->tif_header.classic.tiff_diroff == tif->tif_diroff)
		{
			...
			{
				TIFFErrorExt(tif->tif_clientdata, tif->tif_name,
				    ((const char *)"Error updating TIFF header"));
				return (0);
			}
		}
		else
		{
			...
			while(1) {
				...
				if (!SeekOK(tif, nextdir) ||
					...
					TIFFErrorExt(tif->tif_clientdata, module,
					     ((const char *)"Error fetching directory count"));
					return (0);
				}
				if (tif->tif_flags & TIFF_SWAB)
					TIFFSwabShort(((uint16 *)&dircount));
				(void) TIFFSeekFile(tif,
				    nextdir+2+dircount*12, SEEK_SET);
				if (!ReadOK(tif, &nextnextdir, 4)) {
					TIFFErrorExt(tif->tif_clientdata, module,
					     ((const char *)"Error fetching directory link"));
					return (0);
				}
				if (tif->tif_flags & TIFF_SWAB)
					TIFFSwabLong(((uint32 *)&nextnextdir));
				if (nextnextdir==tif->tif_diroff)
				{
					...
					if (!WriteOK(tif, &m, 4)) {
						TIFFErrorExt(tif->tif_clientdata, module,
						     ((const char *)"Error writing directory link"));
						return (0);
					}
					tif->tif_diroff=0;
					break;
	...
	else
	{
		...
		else
		{
			...
			while(1) {
				...
				{
					TIFFErrorExt(tif->tif_clientdata, module,
					     ((const char *)"Sanity check on tag count failed, likely corrupt TIFF"));
					return (0);
				}
				...
				if (tif->tif_flags & TIFF_SWAB)
					TIFFSwabLong8(((uint64 *)&nextnextdir));
				if (nextnextdir==tif->tif_diroff)
				{
					uint64 m;
					m=0;
...
static int TIFFWriteDirectorySec(TIFF *tif, int isimage, int imagedone, _Ptr<uint64> pdiroff)
{
	...
	if (imagedone)
	{
		if (tif->tif_flags & TIFF_POSTENCODE)
		{
			...
			{
				TIFFErrorExt(tif->tif_clientdata,module,
				    ((const char *)"Error post-encoding before directory write"));
				return (0);
			}
		}
		    ...
		    && (tif->tif_flags & TIFF_BEENWRITING) != 0 )
		{
		    if( !TIFFFlushData1(tif) )
                    {
			TIFFErrorExt(tif->tif_clientdata, module,
			    ((const char *)"Error flushing data before directory write"));
			return (0);
                    }
		}
	...
	while (1)
	{
				...
				for (n=0; n<tif->tif_nfields; n++) {
					...
					if ((o->field_bit>=FIELD_CODEC)&&(TIFFFieldSet(tif,o->field_bit)))
					{
						switch (o->get_field_type)
						{
							...
							default:
								TIFFErrorExt(tif->tif_clientdata,module,
								            ((const char *)"Cannot write tag %d (%s)"),
								            TIFFFieldTag(o),
				...
				case TIFF_RATIONAL:
					{
						...
						if (tv_size == 8) {
							...
							if (tv_size != 4) {
								TIFFErrorExt(0,((const char *)"TIFFLib: _TIFFWriteDirectorySec()"), ((const char *)"Rational2Double: .set_field_type in not 4 but %d"), tv_size); 
							}
						}
					}
					break;
		...
		if (dir==NULL)
		{
			TIFFErrorExt(tif->tif_clientdata,module,((const char *)"Out of memory"));
			goto bad;
		}
		if (isimage)
		{
		...
		{
			TIFFErrorExt(tif->tif_clientdata,module,((const char *)"Maximum TIFF file size exceeded"));
			goto bad;
		}
		...
		if (TIFFFieldSet(tif,FIELD_SUBIFD)&&(tif->tif_subifdoff==0))
		{
			...
			for (na=0, nb=dir; ; na++, nb++)
			{
				if( na == ndir )
                                {
                                    TIFFErrorExt(tif->tif_clientdata,module,
                                                 ((const char *)"Cannot find SubIFD tag"));
                                    goto bad;
                                }
	...
	{
		TIFFErrorExt(tif->tif_clientdata,module,((const char *)"IO error writing directory"));
		goto bad;
	}
...
static int _WriteAsType(_Ptr<TIFF> tif, uint64 strile_size, uint64 uncompressed_threshold)
{
...
static int WriteAsLong8(TIFF *tif : itype(_Ptr<TIFF>), uint64 strile_size)
{
    return _WriteAsType(tif, strile_size, 0xFFFFFFFFU);
}

static int WriteAsLong4(TIFF *tif : itype(_Ptr<TIFF>), uint64 strile_size)
{
    ...
    if( write_aslong4 )
    {
        ...
        */
        ...
        for (q=p, ma=value, mb=0; mb<count; ma++, mb++, q++)
        {
            ...
            {
                TIFFErrorExt(tif->tif_clientdata,module,
                            ((const char *)"Attempt to write value larger than 0xFFFFFFFF in LONG array."));
                _TIFFfree(p);
                return(0);
            }
            *q= (uint32)(*ma);
    ...
    else
    {
        ...
        for (q=p, ma=value, mb=0; mb<count; ma++, mb++, q++)
        {
            if (*ma>0xFFFF)
            {
                ...
                TIFFErrorExt(tif->tif_clientdata,module,
                            ((const char *)"Attempt to write value larger than 0xFFFF in SHORT array."));
                _TIFFfree(p);
                return(0);
            }
            *q= (uint16)(*ma);
...
static int TIFFWriteDirectoryTagIfdIfd8Array(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value)
{
    ...
    */
    ...
    for (q=p, ma=value, mb=0; mb<count; ma++, mb++, q++)
    {
        ...
        {
            TIFFErrorExt(tif->tif_clientdata,module,
                         ((const char *)"Attempt to write value larger than 0xFFFFFFFF in Classic TIFF file."));
            _TIFFfree(p);
            return(0);
        }
        *q= (uint32)(*ma);
...
static int TIFFWriteDirectoryTagSubifd(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir)
{
	...
	if (!(tif->tif_flags&TIFF_BIGTIFF))
	{
		...
		for (p=0; p < tif->tif_dir.td_nsubifd; p++)
		{
                        ...
                        if( *pa > 0xFFFFFFFFUL)
                        {
                            TIFFErrorExt(tif->tif_clientdata,module,((const char *)"Illegal value for SubIFD tag"));
                            _TIFFfree(o);
                            return(0);
                        }
			*pb++=(uint32)(*pa++);
...
static int TIFFWriteDirectoryTagCheckedLong8Array(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, uint64 *value)
{
	...
	assert(sizeof(uint64)==8);
	if( !(tif->tif_flags&TIFF_BIGTIFF) ) {
		TIFFErrorExt(tif->tif_clientdata,((const char *)"TIFFWriteDirectoryTagCheckedLong8Array"),((const char *)"LONG8 not allowed for ClassicTIFF"));
		return(0);
	}
	if (tif->tif_flags&TIFF_SWAB)
...
static int TIFFWriteDirectoryTagCheckedSlong8Array(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint32 count, int64 *value)
{
	...
	assert(sizeof(int64)==8);
	if( !(tif->tif_flags&TIFF_BIGTIFF) ) {
		TIFFErrorExt(tif->tif_clientdata,((const char *)"TIFFWriteDirectoryTagCheckedSlong8Array"),((const char *)"SLONG8 not allowed for ClassicTIFF"));
		return(0);
	}
	if (tif->tif_flags&TIFF_SWAB)
...
static int TIFFWriteDirectoryTagCheckedRational(_Ptr<TIFF> tif, _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, double value)
{
	...
	if (value < 0) 
	{
		TIFFErrorExt(tif->tif_clientdata, module, ((const char *)"Negative value is illegal"));
		return 0;
	} 
	else if (value != value) 
	{
		TIFFErrorExt(tif->tif_clientdata, module, ((const char *)"Not-a-number value is illegal"));
		return 0;
	}
#ifdef not_def
	else if (value==0.0)
...
------------------------------------------------------------------------*/
static void ToRationalEuclideanGCD(double value, int blnUseSignedRange, int blnUseSmallRange, _Ptr<unsigned long long> ullNum, _Ptr<unsigned long long> ullDenom)
{
...
static void DoubleToRational(double value, uint32 *num : itype(_Ptr<uint32>), uint32 *denom : itype(_Ptr<uint32>))
{
	...
	if (value < 0) {
		*num = *denom = 0;
		TIFFErrorExt(0, ((const char *)"TIFFLib: DoubleToRational()"), ((const char *)" Negative Value for Unsigned Rational given."));
		return;
	}
...
#else
		TIFFErrorExt(0, ((const char *)"TIFFLib: DoubleToRational()"), ((const char *)" Num or Denom exceeds ULONG: val=%14.6f, num=%12llu, denom=%12llu | num2=%12llu, denom2=%12llu"), value, ullNum, ullDenom, ullNum2, ullDenom2);
#endif
		assert(0);
	}
...
#else
		TIFFErrorExt(0, ((const char *)"TIFFLib: DoubleToSrational()"), ((const char *)" Num or Denom exceeds LONG: val=%14.6f, num=%12llu, denom=%12llu | num2=%12llu, denom2=%12llu"), neg*value, ullNum, ullDenom, ullNum2, ullDenom2);
#endif
		assert(0);
	}
...
static int TIFFWriteDirectoryTagData(TIFF *tif : itype(_Ptr<TIFF>), _Ptr<uint32> ndir, TIFFDirEntry *dir, uint16 tag, uint16 datatype, uint32 count, uint32 datalength, void *data)
{
	...
	else
	{
		...
		if (!SeekOK(tif,na))
		{
			TIFFErrorExt(tif->tif_clientdata,module,((const char *)"IO error writing tag data"));
			return(0);
		}
		...
		else
		{
			...
			if (tif->tif_flags&TIFF_SWAB)
				TIFFSwabLong8(((uint64 *)&dir[m].tdir_offset.toff_long8));
		}
	}
	(*ndir)++;
	return(1);
...
static int TIFFLinkDirectory(TIFF *tif : itype(_Ptr<TIFF>))
{
	...
	if (tif->tif_flags & TIFF_INSUBIFD)
	{
		if (!(tif->tif_flags&TIFF_BIGTIFF))
		{
			...
			if (!WriteOK(tif, &m, 4)) {
				TIFFErrorExt(tif->tif_clientdata, module,
				     ((const char *)"Error writing SubIFD directory link"));
				return (0);
			}
			/*
	...
	if (!(tif->tif_flags&TIFF_BIGTIFF))
	{
		...
		if (tif->tif_header.classic.tiff_diroff == 0) {
			...
			if (!WriteOK(tif, &m, 4)) {
				TIFFErrorExt(tif->tif_clientdata, tif->tif_name,
					     ((const char *)"Error writing TIFF header"));
				return (0);
			}
			return (1);
		}
...
/* -------------------------------------------------------------------- */
    ...
    {
        TIFFErrorExt( tif->tif_clientdata, module, 
                      ((const char *)"Memory mapped files not currently supported for this operation.") );
        return 0;
    }
    ...
    {
        TIFFErrorExt( tif->tif_clientdata, module, 
                      ((const char *)"Attempt to reset field on directory not already on disk.") );
        return 0;
    }
...
/* -------------------------------------------------------------------- */
    while( dircount > 0 )
    {
        if (!ReadOK(tif, direntry_raw, dirsize)) {
            TIFFErrorExt(tif->tif_clientdata, module,
                         ((const char *)"%s: Can not read TIFF directory entry."),
                         tif->tif_name);
            return 0;
        }
        ...
        if (tif->tif_flags&TIFF_SWAB)
            TIFFSwabShort( ((uint16 *)&entry_tag) );
    ...
    {
        TIFFErrorExt(tif->tif_clientdata, module,
                     ((const char *)"%s: Could not find tag %d."),
                     tif->tif_name, tag );
        return 0;
    }
...
/* -------------------------------------------------------------------- */
    ...
    if (tif->tif_flags&TIFF_SWAB)
        TIFFSwabShort( ((uint16 *)&entry_type) );
    ...
    else
    {
        ...
        if (tif->tif_flags&TIFF_SWAB)
            TIFFSwabLong8( ((uint64 *)&entry_count) );

        memcpy( &entry_offset, direntry_raw + 12, sizeof(uint64) );
        if (tif->tif_flags&TIFF_SWAB)
            TIFFSwabLong8( ((uint64 *)&entry_offset) );
    }
...
/* -------------------------------------------------------------------- */
	...
	tmsize_t i;
        ...
        for( i = 0; i < count; i++ )
        {
            ...
            if( (int64) ((int32 *) buf_to_write)[i] != ((int64 *) data)[i] )
            {
                ...
                TIFFErrorExt( tif->tif_clientdata, module, 
                              ((const char *)"Value exceeds 32bit range of output type.") );
                return 0;
            }
        }
    }
	...
	tmsize_t i;
        ...
        for( i = 0; i < count; i++ )
        {
            ...
            if( (uint64) ((uint16 *) buf_to_write)[i] != ((uint64 *) data)[i] )
            {
                _TIFFfree( buf_to_write );
                TIFFErrorExt( tif->tif_clientdata, module,
                              ((const char *)"Value exceeds 16bit range of output type.") );
                return 0;
            }
        }
    }
    ...
    {
        TIFFErrorExt( tif->tif_clientdata, module,
                      ((const char *)"Unhandled type conversion.") );
        return 0;
    }
...
/* -------------------------------------------------------------------- */
    ...
    {
        TIFFErrorExt(tif->tif_clientdata, module,
                     ((const char *)"%s: Can not write TIFF directory entry."),
                     tif->tif_name);
        return 0;
    }
