...
static void horizontalAccumulateF(uint16 *wp : itype(_Array_ptr<uint16>) count(n), int n, int stride, float *op : itype(_Array_ptr<float>), float *ToLinearF : itype(_Array_ptr<float>))
{
...
static void horizontalAccumulate12(uint16 *wp : itype(_Array_ptr<uint16>) count(n), int n, int stride, int16 *op : itype(_Array_ptr<int16>), float *ToLinearF : itype(_Array_ptr<float>))
{
    register unsigned int  cr, cg, cb, ca, mask;
    register float  t0, t1, t2, t3;
...
static void horizontalAccumulate16(uint16 *wp : itype(_Array_ptr<uint16>) count(n), int n, int stride, uint16 *op : itype(_Array_ptr<uint16>), uint16 *ToLinear16 : itype(_Array_ptr<uint16>))
{
    register unsigned int  cr, cg, cb, ca, mask;
 ...
 * differencing undone.
 */
static void horizontalAccumulate11(uint16 *wp : itype(_Array_ptr<uint16>) count(n), int n, int stride, uint16 *op : itype(_Array_ptr<uint16>))
{
    register unsigned int cr, cg, cb, ca, mask;
...
static void horizontalAccumulate8(uint16 *wp : itype(_Array_ptr<uint16>) count(n), int n, int stride, unsigned char *op, unsigned char *ToLinear8 : itype(_Array_ptr<unsigned char>))
{
    register unsigned int  cr, cg, cb, ca, mask;
...
static void horizontalAccumulate8abgr(uint16 *wp : itype(_Array_ptr<uint16>) count(n), int n, int stride, unsigned char *op, unsigned char *ToLinear8 : itype(_Array_ptr<unsigned char>))
{
    register unsigned int  cr, cg, cb, ca, mask;
...
static void horizontalDifferenceF(float *ip : itype(_Array_ptr<float>) count(n), int n, int stride, uint16 *wp : itype(_Array_ptr<uint16>), uint16 *FromLT2 : itype(_Array_ptr<uint16>))
{
...
static void horizontalDifference16(unsigned short *ip : itype(_Array_ptr<unsigned short>) count(n), int n, int stride, unsigned short *wp : itype(_Array_ptr<unsigned short>), uint16 *From14 : itype(_Array_ptr<uint16>))
{
...
static void horizontalDifference8(unsigned char *ip, int n, int stride, unsigned short *wp : itype(_Array_ptr<unsigned short>), uint16 *From8 : itype(_Array_ptr<uint16>))
{
    register int  r1, g1, b1, a1, r2, g2, b2, a2, mask;
